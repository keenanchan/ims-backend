...
return [
    ...
    'auth' => [
        ...
        // 2. Set this to TRUE. This tells Scribe to apply auth to ALL endpoints by default.
        'default' => true,

        // 3. Tell Scribe you are using a Bearer token
        'in' => 'bearer',

        // 4. (Optional) The name of the parameter, Postman handles this automatically for Bearer tokens
        'name' => 'Authorization',

        // 5. Inject your Postman environment variable!
        'use_value' => '{{auth_token}}',

        'placeholder' => '{YOUR_AUTH_KEY}',
        'extra_info' => 'You can retrieve your token by visiting the login endpoint.',
    ],
